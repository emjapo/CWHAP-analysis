...
# english proficiency
postData <- postData %>%
  mutate(english = recode(english, `1` = "Elementary proficiency", `2`="Limited working proficiency", `3`="Professional working proficiency", `4`="Full professional working proficiency", `5`="Native or bilingual proficiency"))
...
# Lived in America
postData <- postData %>%
  mutate(lived = recode(lived, `1`="Less than 1 year", `2`="1 year", `3`="2 years", `4`="3 years", `5`="4 years", `6`="Greater than 5 years", `7`="Native (All my life)"))
